 ...
 * <b>One-shot model</b>
 * <p>
 * User: "Alexa, ask LogarithmCalculator Helper how to make paper."
 * <p>
 * Alexa:"(reads back recipe for paper)."
 */
public class LogarithmCalculatorSpeechlet implements Speechlet {
    private static final Logger log = LoggerFactory.getLogger(LogarithmCalculatorSpeechlet.class);
    ...
    public SpeechletResponse onLaunch(final LaunchRequest request, final Session session)
        ...
        String speechOutput =
                "Welcome to the Logarithm calculator. You can ask a question like, "
                        + "what's the logarithm value for 8? ... Now, what can I help you with?";
    ...
    private SpeechletResponse getRecipe(Intent intent) {
	        ...
	        if (itemSlot != null && itemSlot.getValue() != null) {
					...
					Long item=Long.parseLong(itemName);
					
					double n=Math.log10(item);
					recipe=Double.toString(n);
	        	}
	        	catch(Exception e){
	        		recipe=null;
	        	}
            ...
            if (recipe != null) {
                ...
                card.setTitle("Logarithm value for " + itemName);
                ...
                // item.
                String speechOutput =
                        "I'm sorry, I currently do not know the logarithm value for the given input " + intent.getSlot(ITEM_SLOT).getValue()
    ...
    private SpeechletResponse getHelp() {
        String speechOutput =
                "You can ask questions about logarithm calculator such as, what's "
                        + "the log value for any number, or, you can say exit... "
                        + "Now, what can I help you with?";
        String repromptText =
                "You can say things like, what's the log value for a"
                        + " 7, or you can say exit... Now, what can I help you with?";
        return newAskResponse(speechOutput, repromptText);
    }
